(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(100, 600, 1, .75);
        platform.create(450, 500, .9, .75);
        platform.create(200, 400, 1, .75);
        platform.create(500, 300, .8, .75);
        platform.create(300, 200, .8, .75);
        platform.create(100, 100, .7, .75);
