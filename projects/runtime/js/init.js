var init = function (window) {
    ...
    var help = draw.textfield('MOVES || w: jump | e: flying jump | s: duck | space: fire | q: hmm...', 
        '20px Arial',
        '#003200', 'left');
    help.x = 10;
    ...
    var instructions = draw.textfield('KEY || ball: touchdown! | players: enemies | goalpost: duck | helmet: jump', 
        '20px Arial',
        '#003200', 'left');
    instructions.x = 10;
    instructions.y = ground.y + ground.getBounds().height + 40;
    view.addChild(instructions);
