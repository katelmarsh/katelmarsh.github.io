...
function toDashCase(string) {
    // YOUR CODE BELOW HERE //
    var dash = string.split(" ").join("-").toLowerCase();
    return dash;
...
function beginsWith(string, char) {
    // YOUR CODE BELOW HERE //
    var lowercase = string.toLowerCase();
    if (lowercase[0] === char.toLowerCase()){
        return true;
    }
    else {
        return false;
...
function endsWith(string, char) {
    // YOUR CODE BELOW HERE //
    var lowercase = string.toLowerCase();
    if (lowercase[lowercase.length-1] === char.toLowerCase()){
        return true;
    }
    else {
        return false;
...
function longest(stringOne, stringTwo) {
    ...
    if (stringTwo.length > stringOne.length){
        ...
        return console.log("they're the same length");
    }
    else {
        return stringOne;
    }
